...
- [ ] **Alert dedup fix**
  ...
  - Backend: `shoplift_detector/app/services/alert_manager.py`
...
- [ ] **ByteTrack параметр tune**
  ...
  - Config: `shoplift_detector/app/config/tracker.yaml` (шинээр үүсгэнэ)
...
- [ ] **OSNet integration**
  ...
  - Module: `shoplift_detector/app/ai/reid.py` (шинээр үүсгэнэ)
...
- [ ] **RAG check при alert**
  ...
  - Module: `shoplift_detector/app/ai/rag_check.py` (шинээр үүсгэнэ)
...
- [ ] **Dynamic FPS controller**
  ...
  - Module: `shoplift_detector/app/streaming/fps_controller.py` (шинээр үүсгэнэ)
...
- [ ] **Batched inference**
  ...
  - Module: `shoplift_detector/app/ai/batch_inference.py` (шинээр үүсгэнэ)
...
- [ ] **Ollama + Qwen2.5-VL 7B setup**
  ...
  - API wrapper: `shoplift_detector/app/ai/vlm_client.py` (шинээр үүсгэнэ)
